...
<body style="background-color: #454545;">
    ...
    <div class="sidebar">
        ...
        <a href="#" class="left-menu-icon" ><i class="bi bi-clock-history"></i></a>
            ...
            <div class="col-sm-12" >
                <div class="panel">
                    <div class="panel-heading">
                        <h2>Historial de Visualizacion</h2>
                    </div>
                </div>
                <table class="table">
                    <thead>
                ...
                <a class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="historial-pdf.php">Exportar PDF</a>
                <b>|</b>
                <a class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="historial-excel.php">Exportar EXCEL</a>
                <b>|</b>
                <a class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="historial-csv.php">Exportar CSV</a>
                <b>|</b>
                <a class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="historial-json.php">Exportar JSON</a>
                <b>|</b>
                <a class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="historial-xml.php">Exportar XML</a>
            </div>
        </div>
    </div>
